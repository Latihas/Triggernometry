...
public class Entity {
    ...
    internal static readonly Dictionary<string, Func<Entity, string[], object>> _methodAccessors
        = new(StringComparer.OrdinalIgnoreCase) {
            ["HasStatus"] = (e, args) => {
    ...
    /// </summary>
    internal static readonly HashSet<string> ValidEntityPropNames = new(_propAccessors.Keys, StringComparer.OrdinalIgnoreCase);

    /// <summary>
    ///     All "method" names that could be used to query a "method" (with arguments). <br />
    ///     Aliases are included. <br />
    /// </summary>
    internal static readonly HashSet<string> ValidEntityMethodNames = new(_methodAccessors.Keys, StringComparer.OrdinalIgnoreCase);
    ...
    internal static readonly HashSet<string> RecommendedEntityPropNames
        = new(ValidEntityPropNames.Except([
