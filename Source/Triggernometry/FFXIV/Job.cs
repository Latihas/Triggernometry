...
public partial class Job {
	public static readonly Job EmptyJob = new() {
		JobType = JobEnum.None
	};
	...
	public static Job GetJob(string name) => _jobByNames.TryGetValue(name, out var job)
		? job
	...
	public string QueryProperty(string propName) => TryQueryProperty(propName, out var result)
		? result
	...
	public bool TryQueryProperty(string propName, out string result) {
		if (TryGetAccessor(propName, out var accessor)) {
