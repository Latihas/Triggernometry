...
public class CsvManager {
    ...
    /// </summary>
    public static CsvManager Instance { get; } = new();
    ...
    private readonly object _lockTables = new();
    ...
    private readonly object _lockTypedTables = new();

    /// <summary>
    ///     Cached mapping from row type name (without suffix) to the corresponding TypedCsvRow type.
    /// </summary>
    private static readonly Dictionary<string, Type> _rowTypeByName = new(StringComparer.OrdinalIgnoreCase);
    ...
    public void LoadTable(string path, Type type = null) {
        ...
        var dictObj = genericMethod.Invoke(this, [table]);
