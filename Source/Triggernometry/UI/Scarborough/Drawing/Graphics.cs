...
namespace Scarborough.Drawing
{
    ...
    public class Graphics : IDisposable
    {
        ...
        public void DrawTextEx(Font font, System.Drawing.FontStyle fs, float fontSize, IBrush brush, ParagraphAlignment pa, TextAlignment ta, float x, float y, float width, float height, string text)
        {
            if (!IsDrawing) throw ThrowHelper.UseBeginScene();
            ...
            if ((fs & System.Drawing.FontStyle.Underline) == System.Drawing.FontStyle.Underline)
            {
                layout.SetUnderline(true, new TextRange(0, text.Length));
            }
            if ((fs & System.Drawing.FontStyle.Strikeout) == System.Drawing.FontStyle.Strikeout)
            {
