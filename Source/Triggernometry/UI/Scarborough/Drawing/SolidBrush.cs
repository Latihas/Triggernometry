...
public class SolidBrush : IDisposable, IBrush {
	...
	public static implicit operator SolidColorBrush(SolidBrush brush) => brush._brush;
	...
	///     <see langword="false" />.
	/// </returns>
	public static bool Equals(SolidBrush left, SolidBrush right) => left?.Equals(right) == true;
}