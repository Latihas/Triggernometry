...
namespace Scarborough.Drawing
{
    ...
    public class SolidBrush : IDisposable, IBrush
    {
        ...
        /// </summary>
        public Brush Brush { get { return _brush; } set { _brush = (SolidColorBrush)value; } }

        /// <summary>
        /// Gets or sets the Color of the underlying Brush.
        /// </summary>
        public Color Color { get { return _brush.Color; } set { _brush.Color = value; } }
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                SolidBrush value = (SolidBrush)obj;
