...
namespace Scarborough.Drawing
{
    ...
    public class LinearGradientBrush : IDisposable, IBrush
    {
        ...
        /// </summary>
        public Brush Brush { get { return _brush; } set { _brush = (SharpDXGradientBrush)value; } }

        /// <summary>
        /// Gets or sets the start point of this LineatGradientBrush.
        /// </summary>
        public Point Start { get { return _brush.StartPoint; } set { _brush.StartPoint = value; } }

        /// <summary>
        /// Gets or sets the end point of this LineatGradientBrush.
        /// </summary>
        public Point End { get { return _brush.EndPoint; } set { _brush.EndPoint = value; } }
