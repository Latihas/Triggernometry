...
public struct Color {
	...
	public int ToARGB() => ((int)(R * 255.0f) << 16 | (int)(G * 255.0f) << 8 | (int)(B * 255.0f) | (int)(A * 255.0f) << 24) & -1;
	...
	public static implicit operator Color(RawColor4 color) => new(color.R, color.G, color.B, color.A);

	/// <summary>
	///     Converts a Color to a SharpDX RawColor4
	/// </summary>
	/// <param name="color"></param>
	public static implicit operator RawColor4(Color color) => new(color.R, color.G, color.B, color.A);
	...
	///     <see langword="false" />.
	/// </returns>
	public static bool Equals(Color left, Color right) => left.Equals(right);
}