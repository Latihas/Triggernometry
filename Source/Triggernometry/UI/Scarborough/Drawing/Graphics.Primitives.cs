...
public struct Circle {
	...
	public static implicit operator SharpDX.Direct2D1.Ellipse(Circle circle) => new(circle.Location, circle.Radius, circle.Radius);
...
public struct Ellipse {
	...
	public static implicit operator SharpDX.Direct2D1.Ellipse(Ellipse ellipse) => new(ellipse.Location, ellipse.RadiusX, ellipse.RadiusY);
...
public struct Point {
	...
	/// <param name="obj">The object to compare with this instance.</param>
	/// <returns>
	///     <see langword="true" /> if <paramref name="obj" /> is a Point and equal to this instance; otherwise,
	///     <see langword="false" />.
	/// </returns>
	public override bool Equals(object obj) {
	...
	public static implicit operator RawVector2(Point point) => new(point.X, point.Y);

	/// <summary>
	///     Converts a SharpDX RawVector2 structure to a Point structure.
	/// </summary>
	/// <param name="vector">A SharpDX RawVector2.</param>
	public static implicit operator Point(RawVector2 vector) => new(vector.X, vector.Y);
...
public struct Rectangle {
	...
	public static Rectangle Create(float x, float y, float width, float height) => new(x, y, x + width, y + height);
	...
	/// <param name="height">The height of the rectangle</param>
	/// <returns>The Rectangle this method creates.</returns>
	public static Rectangle Create(int x, int y, int width, int height) => new(x, y, x + width, y + height);
	...
	/// <param name="obj">The object to compare with this instance.</param>
	/// <returns>
	///     <see langword="true" /> if <paramref name="obj" /> is a Rectangle and equal to this instance; otherwise,
	///     <see langword="false" />.
	/// </returns>
	public override bool Equals(object obj) {
	...
	public static implicit operator RawRectangleF(Rectangle rectangle) => new(rectangle.Left, rectangle.Top, rectangle.Right, rectangle.Bottom);
...
public struct RoundedRectangle {
	...
	public static RoundedRectangle Create(float x, float y, float width, float height, float radius) => new(Rectangle.Create(x, y, width, height), radius);
	...
	/// <param name="radiusY">A value indicating the radius on the y-axis of the corners of a RoundedRectangle.</param>
	/// <returns>The RoundedRectangle this method creates.</returns>
	public static RoundedRectangle Create(float x, float y, float width, float height, float radiusX, float radiusY) => new(Rectangle.Create(x, y, width, height), radiusX, radiusY);
	...
	///     otherwise, <see langword="false" />.
	/// </returns>
	public static bool operator ==(RoundedRectangle left, RoundedRectangle right) => left.Equals(right);
