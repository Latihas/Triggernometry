...
public class Geometry : IDisposable {
	...
	public static implicit operator SharpDX.Direct2D1.Geometry(Geometry geometry) => geometry._geometry;
	...
	///     <see langword="false" />.
	/// </returns>
	public static bool Equals(Geometry left, Geometry right) => left?.Equals(right) == true;
}