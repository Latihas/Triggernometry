...
namespace Triggernometry.UI.CustomControls
{
    public partial class ExpressionTextBox : UserControl
    {
        ...
        /// </summary>
        private static Context contextForValidation = new Context(null) { testByPlaceholder = true };
        ...
        private void UpdateBackground()
        {
            ...
            else if (ExpressionType == SupportedExpressionTypeEnum.Color)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        string rawColor = contextForValidation.ExpandVariables(null, null, false, textBox1.Text);
        ...
        private void TextBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            if (RealPlugin.Instance.cfg.AutoComplete == true)
            {
        ...
        public class TextBox : System.Windows.Forms.TextBox
        {
            ...
            private void HandleDoubleClick(int index)
            {
                ...
                {
                    HashSet<char> separators = new HashSet<char>($"^$¤{{}}[]()<>,.:;=|/\\'\"，。？！、：；（）《》「」『』【】“”‘’…{ParserCommon.LINEBREAK}");
            ...
            protected override void OnKeyDown(KeyEventArgs e)
            {
                ...
                {
                    bool handled = true;
                    bool shouldWrap = SelectionLength != 0 && RealPlugin.Instance.cfg.WrapTextWhenSelected;
                    bool useAbbrev = RealPlugin.Instance.cfg.UseAbbrevInTemplates;
                    switch (e.KeyCode)
                    {
                        // Ctrl + Shift + 4: ${}
                        case Keys.D4:
