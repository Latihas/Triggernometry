...
public unsafe struct VFXList : IEnumerable<VFXListData> {
    public static HashSet<IntPtr> vfxHandlesSet = [];
    private static VFXList* vfxListInstance;

    public static bool CheckVFXHandleExists(IntPtr vfxHandle) => vfxHandlesSet.Contains(vfxHandle);
    /*
    ...
    */
    [FieldOffset(0x0)] private fixed byte list[0x88 * 0x800];
