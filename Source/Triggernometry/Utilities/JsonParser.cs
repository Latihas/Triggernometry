...
internal class JsonParser {
    ...
    private Dictionary<string, object> FixObject(JsonElement ele) {
        var ox = JsonSerializer.Deserialize<Dictionary<string, object>>(ele.ToString(), opts);
        FixComplexTypes(ox);
        return ox;
    }
    ...
    public Dictionary<string, object> Parse(string json) {
        var o = JsonSerializer.Deserialize<Dictionary<string, object>>(json, opts);
        FixComplexTypes(o);
        return o;
    }
}