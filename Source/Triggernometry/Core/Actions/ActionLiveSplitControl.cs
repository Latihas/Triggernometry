...
internal class ActionLiveSplitControl : ActionBase {
    ...
    /// </summary>
    [XmlIgnore] [Action(1)] public OperationEnum Operation { get; set; } = OperationEnum.StartOrSplit;
    ...
    /// </summary>
    [XmlIgnore] [Action(2)] public string CustomPayload { get; set; } = "";

    [XmlAttribute("CustomPayload")] public string Xml_CustomPayload
    {
    ...
    internal override void ExecuteImplementation(ActionInstance ai) {
        ...
        var livesplitController = plug._livesplit;
            ...
            try {
                switch (Operation) {
                    ...
                    case OperationEnum.Resume:
                        ...
                        break;
                    case OperationEnum.CustomPayload:
                        var lscommand = ctx.EvaluateStringExpression(ActionContextLogger, ctx, CustomPayload);
