...
public class ActionPlaySound : ActionBase {
	...
	/// </summary>
	[XmlIgnore] [Action(2, specialtype: ActionAttribute.SpecialTypeEnum.AudioSelector)]
	...
	// todo remove?
	[XmlIgnore] [Action(4)] public bool ExclusivePlayer { get; set; } = true;
	...
	internal override string DescribeImplementation() => I18n.Translate("internal/Action/descplaysound", "play sound file ({0}) at volume ({1}) %", Filename, Volume);
