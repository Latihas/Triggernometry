...
public class ActionWindowMessage : ActionBase {
	...
	/// </summary>
	[XmlIgnore] [Action(1, typeof(uint))] // -1 uint? 
	...
	/// </summary>
	[XmlIgnore] [Action(2)] public string WindowTitle { get; set; } = "";
	...
	/// </summary>
	[XmlIgnore] [Action(3, typeof(uint))] public string MessageId { get; set; } = "";

	[XmlAttribute("MessageId")] public string Xml_MessageId {
	...
	/// </summary>
	[XmlIgnore] [Action(4, typeof(int))] public string Wparam { get; set; } = "";

	[XmlAttribute("Wparam")] public string Xml_Wparam {
	...
	/// </summary>
	[XmlIgnore] [Action(5, typeof(int))] public string Lparam { get; set; } = "";

	[XmlAttribute("Lparam")] public string Xml_Lparam {
	...
	internal override void ExecuteImplementation(ActionInstance ai) {
		...
		var code = (int)ctx.EvaluateNumericExpression(ActionContextLogger, ctx, MessageId);
		var wparam = (IntPtr)ctx.EvaluateNumericExpression(ActionContextLogger, ctx, Wparam);
		var lparam = (IntPtr)ctx.EvaluateNumericExpression(ActionContextLogger, ctx, Lparam);
