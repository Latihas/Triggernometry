...
public class ActionMouse : ActionBase {
	...
	/// </summary>
	[XmlIgnore] [Action(1)] public OperationEnum Operation { get; set; } = OperationEnum.Move;
	...
	/// </summary>
	[XmlIgnore] [Action(2)] public CoordinateEnum Coordinate { get; set; } = CoordinateEnum.Absolute;

	[XmlAttribute("Coordinate")] public string Xml_Coordinate {
	...
	/// </summary>
	[XmlIgnore] [Action(3, typeof(int))] public string X { get; set; } = "0";
	...
	/// </summary>
	[XmlIgnore] [Action(4, typeof(int))] public string Y { get; set; } = "0";
	...
	internal override void ExecuteImplementation(ActionInstance ai) // todo: avoid Sleep
	{
		...
		var mousex = (int)ctx.EvaluateNumericExpression(ActionContextLogger, ctx, X);
		var mousey = (int)ctx.EvaluateNumericExpression(ActionContextLogger, ctx, Y);
