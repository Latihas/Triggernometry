...
[XmlRoot(ElementName = "OverlayText")]
    public class ActionOverlayText : ActionBase
    {
	...
	/// </summary>
	[XmlIgnore] public OperationEnum Operation { get; set; } = OperationEnum.Activate;
	...
	/// </summary>
	[XmlIgnore] public TextAlignmentEnum Alignment { get; set; } = TextAlignmentEnum.MiddleCenter;

	[XmlAttribute("Alignment")] public string Xml_Alignment {
	...
	///     Text display effect
	/// </summary>
	[XmlIgnore] public EffectEnum Effect { get; set; } = EffectEnum.None;

	[XmlAttribute("Effect")] public string Xml_Effect {
	...
	///     Font size
	/// </summary>
	[XmlIgnore] public float FontSize { get; set; } = 10.0f;

	[XmlAttribute("FontSize")] public string Xml_FontSize {
	...
	///     Color of the text
	/// </summary>
	[XmlIgnore] public string ForeColor { get; set; } = "";

	[XmlAttribute("ForeColor")] public string Xml_ForeColor {
	...
	/// </summary>
	[XmlIgnore] public string BackColor { get; set; } = "";

	[XmlAttribute("BackColor")] public string Xml_BackColor {
	...
	/// </summary>
	[XmlIgnore] public string OutlineColor { get; set; } = "";

	[XmlAttribute("OutlineColor")] public string Xml_OutlineColor {
	...
	/// </summary>
	[XmlIgnore] public string XIniExpression { get; set; } = "";

	[XmlAttribute("XIniExpression")] public string Xml_XIniExpression {
	...
	/// </summary>
	[XmlIgnore] public string YIniExpression { get; set; } = "";

	[XmlAttribute("YIniExpression")] public string Xml_YIniExpression {
	...
	/// </summary>
	[XmlIgnore] public string WIniExpression { get; set; } = "";

	[XmlAttribute("WIniExpression")] public string Xml_WIniExpression {
	...
	/// </summary>
	[XmlIgnore] public string HIniExpression { get; set; } = "";

	[XmlAttribute("HIniExpression")] public string Xml_HIniExpression {
	...
	/// </summary>
	[XmlIgnore] public string OIniExpression { get; set; } = "";

	[XmlAttribute("OIniExpression")] public string Xml_OIniExpression {
	...
	/// </summary>
	[XmlIgnore] public string XTickExpression { get; set; } = "";

	[XmlAttribute("XTickExpression")] public string Xml_XTickExpression {
	...
	/// </summary>
	[XmlIgnore] public string YTickExpression { get; set; } = "";

	[XmlAttribute("YTickExpression")] public string Xml_YTickExpression {
	...
	/// </summary>
	[XmlIgnore] public string WTickExpression { get; set; } = "";

	[XmlAttribute("WTickExpression")] public string Xml_WTickExpression {
	...
	/// </summary>
	[XmlIgnore] public string HTickExpression { get; set; } = "";

	[XmlAttribute("HTickExpression")] public string Xml_HTickExpression {
	...
	/// </summary>
	[XmlIgnore] public string OTickExpression { get; set; } = "";

	[XmlAttribute("OTickExpression")] public string Xml_OTickExpression {
	...
	/// </summary>
	[XmlIgnore] public string TTLTickExpression { get; set; } = "";

	[XmlAttribute("TTLTickExpression")] public string Xml_TTLTickExpression {
	...
	/// </summary>
	[XmlIgnore] public string Font { get; set; } = "";

	[XmlAttribute("Font")] public string Xml_Font {
	...
	internal override void ExecuteImplementation(ActionInstance ai) {
		...
		plug.TextAuraManagement(ctx, (ActionOld)this); // todo supposed to be a reference to this action
	}
