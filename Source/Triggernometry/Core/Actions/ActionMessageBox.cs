...
[XmlRoot(ElementName = "MessageBox")]
	...
	/// </summary>
	[XmlIgnore] [Action(1)] public MessageBoxIconEnum Icon { get; set; } = MessageBoxIconEnum.None;

	[XmlAttribute("Icon")] public string Xml_Icon {
	...
	/// </summary>
	[XmlIgnore] [Action(2)] public string Text { get; set; } = "";
	...
	internal override string DescribeImplementation() => I18n.Translate($"internal/Action/descmsgbox{Icon}", "show a message box saying ({0}) with icon (" + Icon + ")", Text);
