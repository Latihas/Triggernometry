...
public sealed class ConditionGroup : ConditionComponent {
    ...
    [XmlIgnore] private CndGroupingEnum _Grouping = CndGroupingEnum.Or;
    [XmlAttribute] public CndGroupingEnum Grouping
    {
        get => _Grouping;
        set
        {
    ...
    [XmlElement(typeof(ConditionGroup))] [XmlElement(typeof(ConditionSingle))]
    public List<ConditionComponent> Children { get; set; } = [];
