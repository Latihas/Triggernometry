...
#pragma warning restore CS0612
        ...
        public string DictSourcePersist
        {
            ...
            set
            {
                _DictSourcePersist = bool.Parse(value);
            }
        }
        ...
        public string DictTargetPersist
        {
            ...
            set
            {
                _DictTargetPersist = bool.Parse(value);
            }
        }
        ...
        public string DiskFileCache
        {
            ...
            set
            {
                _DiskFileCache = bool.Parse(value);
            }
        }
        ...
        public string JsonCacheRequest
        {
            ...
            set
            {
                _JsonCacheRequest = bool.Parse(value);
            }
        }
        ...
        public string JsonResultVariablePersist
        {
            ...
            set
            {
                _JsonResultVariablePersist = bool.Parse(value);
            }
        }
        ...
        public string ListSourcePersist
        {
            ...
            set
            {
                _ListSourcePersist = bool.Parse(value);
            }
        }
        ...
        public string ListTargetPersist
        {
            ...
            set
            {
                _ListTargetPersist = bool.Parse(value);
            }
        }
        ...
        public string LogProcessACT
        {
            ...
            set
            {
                _LogProcessACT = bool.Parse(value);
            }
        }
        ...
        public List<ActionOld> LoopActions = new List<ActionOld>();
        ...
        public string PlaySoundExclusive
        {
            ...
            set
            {
                _PlaySoundExclusive = bool.Parse(value);
            }
        }
        ...
        public string UseTTSExclusive
        {
            ...
            set
            {
                _UseTTSExclusive = bool.Parse(value);
            }
        }
        ...
        public string VariableTargetPersist
        {
            ...
            set
            {
                _VariableTargetPersist = bool.Parse(value);
            }
        }
        ...
        public string VariablePersist
        {
            ...
            set
            {
                _VariablePersist = bool.Parse(value);
            }
        }
        ...
        public string TableSourcePersist
        {
            ...
            set
            {
                _TableSourcePersist = bool.Parse(value);
            }
        }
        ...
        public string TableTargetPersist
        {
            ...
            set
            {
                _TableTargetPersist = bool.Parse(value);
            }
        }
